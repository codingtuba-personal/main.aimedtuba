<template>
    <div>
        <div class="lgray-div apps-div">
            ...
            <component :is="website_code+'aimedtuba-app'" :code="secure.pictures.codes.website" description="my pictures website, not mobile freindly (50/50 for update)" name="pictures.aimedtuba.com" url="http://$name/?$code=code" style="display:inline"></component>
